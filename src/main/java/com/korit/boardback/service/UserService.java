...
public class UserService {
    ...
    public User loginUser(ReqLoginDto reqLoginDto) throws NotFoundException{
        User user = User.builder()
                .username(reqLoginDto.getUsername())
                .password(reqLoginDto.getPassword())
                .build();
        return userRepository.login(user).orElseThrow(() -> new NotFoundException("잘못된 정보입니다."));
    }
